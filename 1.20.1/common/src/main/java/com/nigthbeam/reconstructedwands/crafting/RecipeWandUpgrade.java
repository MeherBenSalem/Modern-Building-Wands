...
public class RecipeWandUpgrade extends CustomRecipe {
    ...
    public RecipeWandUpgrade(ResourceLocation id, CraftingBookCategory category) {
        super(id, category);
    }
    ...
    @NotNull
    @Override
    public ItemStack assemble(@NotNull CraftingContainer input, @NotNull RegistryAccess registries) {
        ItemStack wand = null;
        IWandUpgrade upgrade = null;
