...
public class ModMessages {
    public static void register() {
        ...
        PayloadTypeRegistry.playC2S().register(PacketQueryUndo.TYPE, PacketQueryUndo.STREAM_CODEC);
        PayloadTypeRegistry.playS2C().register(PacketUndoBlocks.TYPE, PacketUndoBlocks.STREAM_CODEC);
